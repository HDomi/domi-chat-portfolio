...
const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  React.useEffect(() => {
    if (isOpen) {
      ...
      const timeoutId = setTimeout(() => setShouldRender(false), 200) // Match animation duration (0.2s)
  ...
  return (
    ...
    >
      ...
      {/* Modal Content */}
      <div
        className={`relative bg-[#2a2b2e] border border-gray-700 rounded-xl p-5 md:p-6 w-[90%] max-w-sm shadow-xl transform transition-all ${
